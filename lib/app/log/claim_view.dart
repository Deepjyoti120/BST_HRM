...
class _ClaimViewState extends State<ClaimView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: globalAppBar("Claim Status View"),
      body: Row(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                 ...
                                 ),visible:leave["claim_type"].toString().toLowerCase()!="transport" &&  leave["claim_type"].toString().toLowerCase()!="others"  ),
  ...
  // Encode resized image to PNG format with reduced quality (adjust the level as needed)
  final List<int> resizedBytes = Img.encodePng(resizedImage, level: 50)!; // Adjust the compression level here
